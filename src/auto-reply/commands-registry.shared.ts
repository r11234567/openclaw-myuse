...
export function buildBuiltinChatCommands(
  ...
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "archives",
      nativeName: "archives",
      description: "List archived chats for this conversation.",
      textAliases: ["/archives", "/tg_archives"],
      category: "session",
      tier: "standard",
      args: [
        {
    ...
    defineChatCommand({
      key: "use",
      nativeName: "use",
      description: "Switch this chat to an archived conversation.",
      textAliases: ["/use", "/tg_use", "/archive_use", "/switch_archive"],
      category: "session",
      tier: "standard",
      args: [
        {
          name: "index",
          description: "Archive code from /archives",
          type: "string",
          required: true,
        },
      ],
    ...
    defineChatCommand({
      key: "delete",
      nativeName: "delete",
      description: "Delete an archived conversation.",
      textAliases: ["/delete", "/tg_delete", "/archive_delete"],
      category: "session",
      tier: "standard",
      args: [
        {
    ...
    defineChatCommand({
      key: "current",
      nativeName: "current",
      description: "Show the active session key.",
      textAliases: ["/current", "/tg_current", "/current_tg"],
      category: "session",
      tier: "power",
    }),
    defineChatCommand({
